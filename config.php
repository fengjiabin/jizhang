...
$db_servername="192.168.1.10";//Mysql服务器地址 将 localhost 修改为你的数据库地址
$db_username="root";//数据库用户名 将 username 修改为你的数据库用户名
$db_password="123456";//数据库密码 将 password 修改为你的数据库密码
$db_dbname="jizhang";//数据库名 将 jizhang 修改为你的数据库名
$qianzui="ji_";//表前缀
$zyemail="fengjiabin5350@126.com";//配置找回密码邮箱，推荐163邮箱
$zyemailpass="FengJiabin1991";//邮箱密码
