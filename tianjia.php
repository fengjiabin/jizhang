...
<input style="height:26px;" name="money" type="number" id="money" size="8"  step="0.01" max="99999.9" min="0" /><div style="display:none;"><input name="zhifu" type="text" id="zhifu" value="2" size="8" /></div>
&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">分类：</font>
					<select name="classid"  id="classid"  style="width:55px;height:26px;color:red;" >
						<?php
...
&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">备注：</font>
				...
				<br /><br />
&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">时间：<input type="text" name="time" id="time" value="<?php $xz=date("Y-m-d H:i:s");;echo "$xz"; ?>"/></font>
				<font color="red"><b><input name="Submit" type="submit" id="Submit" value="记账" /></b></font><a href="piliangtianjia.php" style="color:#ccc;">批量</a>
	  </form>
	</td>
</tr>
...
<input style="height:26px;" name="money" type="number" id="money" value="" size="8"  step="0.01" max="99999.9" min="0"/><div style="display:none;"><input name="zhifu" type="text" id="zhifu" value="1" size="8" /></div>
<font color="MediumSeaGreen">分类：</font>
<select name="classid" id="classid" style="width:55px;height:26px;color:Green;">
              <?php
          ...
          <br /><br />
&nbsp;&nbsp;&nbsp;&nbsp;<font color="MediumSeaGreen">备注：</font><input name="remark" type="text" id="remark" /> <font color="#ccc">方便搜索</font>
          <br /><br />
&nbsp;&nbsp;&nbsp;&nbsp;<font color="MediumSeaGreen">时间：<input type="text" name="time" id="time" value="<?php $xz=date("Y-m-d H:i:s");;echo "$xz"; ?>"/></font>
            <font color="green"><b><input type="submit" name="Submit" value="记账" /></b></font><a href="piliangtianjia.php" style="color:#ccc;">批量</a>
 </form>
...
$query=mysql_query($query_sql);
			...
			echo "<table width='100%' border='0' align='left' cellpadding='5' cellspacing='1' bgcolor='#B3B3B3' class='table table-striped table-bordered'>
                ...
                <th bgcolor='#EBEBEB'><font color='green'>收</font><font color='red'>支</font></th>
    ...
    die(mysql_error()); // TODO: better error handling
			...
			while($row = mysql_fetch_array($query)){
                ...
                echo "<td align='left' bgcolor='#FFFFFF'><font color='MediumSeaGreen'>".date("d号H:i",$row[actime])."</font></td>";
               ...
               echo "<td align='left' bgcolor='#FFFFFF'><font color='red'>".date("d号H:i",$row[actime])."</font></td>";
...
echo "</td></tr></table>";
	...
	<?php
		  ...
		  ?>	  
<?php $oo=$income-$spending?>
<script language="javascript">
document.getElementById("tongji").innerHTML="<?='总共收入<font color=MediumSeaGreen>'.$income.'</font> 总共支出 <font color=red>'.$spending.'</font>结余<font color=blue><b>'.$oo.'</b></font>'?>"
</script>
